...
<body>
                    ...
                    <article class="media">
                        ...
                        <nav class="level is-mobile">
                            <div class="level-left">
                                <a class="level-item <?php if($task->task_status == 4) {echo "is-hidden";} ?>" href="./view-one-task?task_id=<?php echo $task->task_id; ?>">
                                    See Details
                                </a>
                            </div>
                            <div class="level-left">
    ...
    <footer>
        <div class="container is-fluid has-background-dark has-text-white">
            ...
            <p class="content">
                A SQL statement gets all the tasks in the task_T table. Later, Unit A will provide a user_id to narrow down the visible tasks.
                At the moment, all the tasks are visible.
                A while loop generates all the tasks.
