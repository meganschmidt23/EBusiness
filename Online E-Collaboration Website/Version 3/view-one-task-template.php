...
<body>
    ...
    <footer>
        <div class="container is-fluid has-background-dark has-text-white">
            ...
            <p class="content">
                A USER OF 2 IS HARD-CODED INTO THIS PAGE. 
                In the future, Unit A will give us the user_id with a session variable.
                A SQL statement fetches data from taskTemplate_T based on the taskTemplate_id passed as a query parameter.
                <!-- A SQL statement fetches the appropriate taskTemplateDetails_T row based on taskTemplate_id and user_id.
                Most of the data on this page comes from those two queries.
                For task data, this is currently a placeholder; we would pass an id to get the right form or file.-->
                For task template actions, this is a form to toggle templateStatus_id between 1, 2, and 3.
                There is a quick SQL query to convert the templateStatus_id number into the legible text Ready, Not-Ready, and Deleted.
                ...
                In the future, Unit A will provide the user_id alongside the role_id; we can then hide/display the task template admin based on that role_id.
            </p>
            <br>
        </div>
    </footer>
