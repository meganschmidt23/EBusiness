...
$data_results = mysqli_query($link, 'SELECT data_id, data_location FROM data_T WHERE dataType_id = 4 OR dataType_id = 5');
    ...
    <section class="section">
        <div class="columns">
            <div class="column is-2">
                <div class="container">
                    <?php $current_topic = "task"; include "./vertical-menu.php"; ?>
                </div>
            </div>
                ...
                <div class="box">
                                ...
                                <select name="add_data_id" id="add_data_id">
                                    <?php while($data = mysqli_fetch_object($data_results) )  { ?>
                                        <option value="<?php echo $data->data_id ?>">
                                            <?php
                                                $stringURL = $data->data_location;
                                                $stringArr = explode("/", $stringURL);
                                                echo $stringArr[2];
                                            ?>
                                        </option>
                                    <?php } ?>
                    ...
                    <section>
                        <div class="level">
                            <div class="level-item">
                                <div>
                                    <h2 class="title is-6">Access Contracts (PLACEHOLDER UNIT A)</h2>
                                </div>
                            </div>
                            <div class="level-item">
                                <div>
                    ...
                    <section class="section">
                        <a href="./view-one-task.php?task_id=<?php echo $current_task_id; ?>">
                            <button class="button is-info">Return to Task Overview</button>
                        </a>
                    </section>
                </div>
            </div>
