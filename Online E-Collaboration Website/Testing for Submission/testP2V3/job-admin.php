...
$task_results = mysqli_query($link, 'SELECT jobDetails_T.task_id AS task_id, task_T.task_title AS task_title, jobDetails_T.job_taskOrder AS job_taskOrder FROM jobDetails_T INNER JOIN task_T ON jobDetails_T.task_id = task_T.task_id WHERE job_id = '. $current_job_id . ' ORDER BY job_taskOrder');
