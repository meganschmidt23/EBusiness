...
if($_SESSION['userRole_id'] == 1) {
    ...
    $job_results = mysqli_query($link, 
    'SELECT * FROM job_T WHERE job_owner = '. $_GET['job_id']);
}
                    ...
                    <tbody>
                        ...
                        <?php while($job = mysqli_fetch_object($job_results) )  { ?>
                            <tr>
                                ...
                                <td>
                                    <a class="<?php echo $admin_form_disabled;?>" href="./job-admin.php?job_id=<?php echo $job->job_id; ?>"><button class="button">Admin Panel</button></a>
                                </td>
                                <td>
                                    <a href="./view-jobs-table.php?job_id=<?php echo $job->job_id; ?>&change_status=3"><button class="button">Delete</button></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
